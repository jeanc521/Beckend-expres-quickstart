...
routes.post("/list", (req: Request, res: Response): any => userController.create(req, res))
routes.get("/list", (req: Request, res: Response): any => userController.read(req, res))
routes.put("/list/:id", (req: Request, res: Response): any => userController.update(req, res))
routes.delete("/list/:id", (req: Request, res: Response): any => userController.delete(req, res))
